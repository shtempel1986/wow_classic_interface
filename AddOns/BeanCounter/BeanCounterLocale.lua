--[[
	...
	Revision: $Id: BeanCounterLocale.lua 6983 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterLocale.lua $","$Rev: 6983 $","5.1.DEV.", 'auctioneer', 'libs')
