--[[
	...
	Version: 3.4.6983 (SwimmingSeadragon)
	Revision: $Id: BeanCounterFrames.lua 6983 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterFrames.lua $","$Rev: 6983 $","5.1.DEV.", 'auctioneer', 'libs')
...
function private.CreateFrames()
	...
	if base.SetResizeBounds then -- detect which bounds method to use
