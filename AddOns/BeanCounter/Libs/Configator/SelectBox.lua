--[[
	...
	Revision: $Id: SelectBox.lua 6987 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/SelectBox.lua $","$Rev: 6987 $","5.1.DEV.", 'auctioneer', 'libs')
