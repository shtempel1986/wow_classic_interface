--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6961 2023-08-28 00:00:20Z none $
...
do -- tooltip class definition
	...
	function lib:Activate()
		...
		activated = true
		local success, errortext = libTT:RegisterTooltip(GameTooltip)
		-- This is a test for a change in the API, i.e. removal of an essential API function from GameTooltip
		if not success then
			error("Tiphelper could not register GameTooltip with LibExtraTip, reason: "..tostring(errortext))
		end
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6961 $","5.12.DEV.", 'auctioneer', 'libs')
