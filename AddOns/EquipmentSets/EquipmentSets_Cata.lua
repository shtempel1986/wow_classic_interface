...
function unequipWeaponsRingsAndTrinkets()
    C_Timer.After(0.1, function()
        ...
        C_Timer.After(0.1, function()
            PickupInventoryItem(11) PutItemInBag(31);
            PickupInventoryItem(12) PutItemInBag(31);
            PickupInventoryItem(13) PutItemInBag(31);
            PickupInventoryItem(14) PutItemInBag(31);
            PickupInventoryItem(16) PutItemInBag(31);
            PickupInventoryItem(17) PutItemInBag(31);
            C_Timer.After(0.1, function()
                PickupInventoryItem(11) PutItemInBag(32);
                PickupInventoryItem(12) PutItemInBag(32);
                PickupInventoryItem(13) PutItemInBag(32);
                PickupInventoryItem(14) PutItemInBag(32);
                PickupInventoryItem(16) PutItemInBag(32);
                PickupInventoryItem(17) PutItemInBag(32);
                C_Timer.After(0.1, function()
                    PickupInventoryItem(11) PutItemInBag(33);
                    PickupInventoryItem(12) PutItemInBag(33);
                    PickupInventoryItem(13) PutItemInBag(33);
                    PickupInventoryItem(14) PutItemInBag(33);
                    PickupInventoryItem(16) PutItemInBag(33);
                    PickupInventoryItem(17) PutItemInBag(33);
                    C_Timer.After(0.1, function()
                        PickupInventoryItem(11) PutItemInBag(34);
                        PickupInventoryItem(12) PutItemInBag(34);
                        PickupInventoryItem(13) PutItemInBag(34);
                        PickupInventoryItem(14) PutItemInBag(34);
                        PickupInventoryItem(16) PutItemInBag(34);
                        PickupInventoryItem(17) PutItemInBag(34);
                    end)
                end)
            end)
        end)
...
function loadTheSet(currentSetNumber)
    ...
    if next(_G[theCurrentSavedSet]) == nil then
        ...
        for x = 1, 20 do
            if _G[theCurrentSavedSet][x] == _G[theCurrentSavedSet][1] then -- If Ammo
                ...
                --Cata Beta broke this, using x-2 instead for now
                --EquipItemByName(_G[theCurrentSavedSet][x], x-2) -- Equip to specific slot
            end
        end
        ...
        C_Timer.After(1, function()
            if tostring(_G[theCurrentSavedSet][18]) == tostring(_G[theCurrentSavedSet][17]) then
                ...
                --Cata Beta broke this, adding -1 instead for now
                --EquipItemByName(_G[theCurrentSavedSet][18], 17-1)
            ...
            if tostring(_G[theCurrentSavedSet][15]) == tostring(_G[theCurrentSavedSet][14]) then
                ...
                --Cata Beta broke this, adding -1 instead for now
                --EquipItemByName(_G[theCurrentSavedSet][15], 14-1)
            ...
            if tostring(_G[theCurrentSavedSet][13]) == tostring(_G[theCurrentSavedSet][12]) then
                ...
                --Cata Beta broke this, adding -1 instead for now
                --EquipItemByName(_G[theCurrentSavedSet][13], 12-1)
    ...
    for i=0,20 do
        if tostring(_G[theCurrentSavedSet][i]) == "EMPTY SLOT" then
            ...
            nbOfFreeSlotsInBag0, theBagType = C_Container.GetContainerNumFreeSlots(0);
            nbOfFreeSlotsInBag1, theBagType = C_Container.GetContainerNumFreeSlots(1);
            nbOfFreeSlotsInBag2, theBagType = C_Container.GetContainerNumFreeSlots(2);
            nbOfFreeSlotsInBag3, theBagType = C_Container.GetContainerNumFreeSlots(3);
            nbOfFreeSlotsInBag4, theBagType = C_Container.GetContainerNumFreeSlots(4);

            if nbOfFreeSlotsInBag0 > 0 then
                PickupInventoryItem(i-1) PutItemInBackpack();
            elseif nbOfFreeSlotsInBag1 > 0 then
                PickupInventoryItem(i-1) PutItemInBag(31);
            elseif nbOfFreeSlotsInBag2 > 0 then
                PickupInventoryItem(i-1) PutItemInBag(32);
            elseif nbOfFreeSlotsInBag3 > 0 then
                PickupInventoryItem(i-1) PutItemInBag(33);
            elseif nbOfFreeSlotsInBag4 > 0 then
                PickupInventoryItem(i-1) PutItemInBag(34);
            else --error("Not enough empty bag slots.")
            end
...
function unequipEverythingWorn()
    for x=0,20 do
        ...
        if nbOfFreeSlotsInBag0 > 0 then
            PickupInventoryItem(x-1) PutItemInBackpack();
        elseif nbOfFreeSlotsInBag1 > 0 then
            PickupInventoryItem(x-1) PutItemInBag(31);
        elseif nbOfFreeSlotsInBag2 > 0 then
            PickupInventoryItem(x-1) PutItemInBag(32);
        elseif nbOfFreeSlotsInBag3 > 0 then
            PickupInventoryItem(x-1) PutItemInBag(33);
        elseif nbOfFreeSlotsInBag4 > 0 then
            PickupInventoryItem(x-1) PutItemInBag(34);
        else --error("Not enough empty bag slots.")
        end
    end
end
...
function unequipEverythingWornOLD()
    ...
    function removeToBag1()
        for x=0,19 do
            PickupInventoryItem(x) PutItemInBag(31);
        end
    end
    function removeToBag2()
        for x=0,19 do
            PickupInventoryItem(x) PutItemInBag(32);
        end
    end
    function removeToBag3()
        for x=0,19 do
            PickupInventoryItem(x) PutItemInBag(33);
        end
    end
    function removeToBag4()
        for x=0,19 do
            PickupInventoryItem(x) PutItemInBag(34);
        end
    end
    C_Timer.After(0.2, function()
        removeToInv()
...
dropDown:SetPoint("BOTTOMLEFT", 18, 2, 0, 0)
...
dropDown2:SetPoint("BOTTOMLEFT", 76, 2, 80, 80)
