--[[
	...
	Version: 3.4.6979 (SwimmingSeadragon)
	Revision: $Id: EnxAutoDisenchant.lua 6979 2023-08-28 00:00:20Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxAutoDisenchant.lua $", "$Rev: 6979 $")
...
local function initUI()
	...
	for i = 1, 5 do
		...
		auto_de_prompt.Lines[i]:SetWidth(370)
...
--		local tex = source:GetNormalTexture()		-- this is returning NIL in 5.0.4
	...
	if WOW_PROJECT_ID == WOW_PROJECT_MAINLINE then
		-- in 10.x need to register for both up and down clicks; only one will be active depending on cVar ActionButtonUseKeyDown
		-- for other clients leave as default (which should be "LeftButtonUp")
