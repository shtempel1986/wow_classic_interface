--[[
	...
	Revision: $Id: EnxMain.lua 6979 2023-08-28 00:00:20Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxMain.lua $", "$Rev: 6979 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Rev: 6979 $")
