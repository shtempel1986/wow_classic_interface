--[[
	Auctioneer
	Version: 3.4.6952 (SwimmingSeadragon)
	Revision: $Id: CoreManifest.lua 6952 2023-08-28 00:00:20Z none $
...
lib.RegisterRevision("$URL: Auc-Advanced/CoreManifest.lua $", "$Rev: 6952 $")
