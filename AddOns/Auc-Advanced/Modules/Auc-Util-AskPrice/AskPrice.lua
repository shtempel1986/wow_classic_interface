--[[
	...
	Version: 3.4.6896 (SwimmingSeadragon)
	Revision: $Id: AskPrice.lua 6896 2023-08-28 00:00:20Z none $
...
function private.GetVersion()
	return tonumber(("$Rev: 6896 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 6896 $")
