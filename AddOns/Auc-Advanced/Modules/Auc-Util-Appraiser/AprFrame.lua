--[[
	...
	Version: 3.4.6971 (SwimmingSeadragon)
	Revision: $Id: AprFrame.lua 6971 2023-08-28 00:00:20Z none $
...
function private.CreateFrames()
	...
	function frame.DisplaySelectedItem(item, sig, pos)
		...
		if not item[3] and frame.salebox.icon.ClearNormalTexture then -- ### hybrid
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-Appraiser/AprFrame.lua $", "$Rev: 6971 $")
