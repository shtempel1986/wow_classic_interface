--[[
	...
	Version: 3.4.6900 (SwimmingSeadragon)
	Revision: $Id: OutlierFilter.lua 6900 2023-08-28 00:00:20Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 6900 $")
