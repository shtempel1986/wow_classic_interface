--[[
	...
	Version: 3.4.6902 (SwimmingSeadragon)
	Revision: $Id: Auc-Util-AHWindowControl.lua 6902 2023-08-28 00:00:20Z none $
...
local function OnMouseUp(frame)
	...
	private.setAnchors(frame:GetPoint(1)) --store the current anchor points
end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AHWindowControl/Auc-Util-AHWindowControl.lua $", "$Rev: 6902 $")
