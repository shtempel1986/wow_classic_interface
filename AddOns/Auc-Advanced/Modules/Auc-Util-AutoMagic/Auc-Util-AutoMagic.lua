--[[
	...
	Revision: $Id: Auc-Util-AutoMagic.lua 6940 2023-08-28 00:00:20Z none $
...
function lib.setWorkingItem(link)
	...
	if not texture and autosellframe.slot.ClearNormalTexture then -- ### hybrid
...
function autosellframe.ClearIcon()
	...
	if autosellframe.slot.ClearNormalTexture then -- ### hybrid
		autosellframe.slot:ClearNormalTexture()
	else
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AutoMagic/Auc-Util-AutoMagic.lua $", "$Rev: 6940 $")
