--[[
	PanelScroller
	Version: 3.4.6987 (SwimmingSeadragon)
	Revision: $Id: PanelScroller.lua 6987 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/PanelScroller.lua $","$Rev: 6987 $","5.1.DEV.", 'auctioneer', 'libs')
