...
CENSUSPLUS_BADLOCAL_3 = "If this is incorrect, please let Bringoutyourdead know at WoWTBCPopulation.com about your situation so he can make corrections.";
...
CENSUSPLUS_UNKNOWNRACE_ACTION = " ), please tell christophrus at WoWTBCPopulation.com";
CENSUSPLUS_UNPAUSE = "Resume";
CENSUSPLUS_UNPAUSECENSUS = "Resume the current census";
CENSUSPLUS_UPLOAD = "There is currently no census website to upload census data to.";
