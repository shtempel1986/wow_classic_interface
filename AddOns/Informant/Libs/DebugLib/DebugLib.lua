--[[
	...
	Version: 3.4.6882 (SwimmingSeadragon)
	Revision: $Id: DebugLib.lua 6882 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/DebugLib/DebugLib.lua $","$Rev: 6882 $","5.1.DEV.", 'auctioneer', 'libs')
