--[[
	...
	Version: 3.4.6885 (SwimmingSeadragon)
	Revision: $Id: Babylonian.lua 6885 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Babylonian/Babylonian.lua $","$Rev: 6885 $","5.1.DEV.", 'auctioneer', 'libs')
