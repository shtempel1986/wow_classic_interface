--[[
	...
	Version: 3.4.6977 (SwimmingSeadragon)
	Revision: $Id: Swatter.lua 6977 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: !Swatter/Swatter.lua $","$Rev: 6977 $","6.0.DEV.", 'auctioneer', 'libs')
