--[[
	...
	Version: 3.4.6920 (SwimmingSeadragon)
	Revision: $Id: Stubby.lua 6920 2023-08-28 00:00:20Z none $
...
LibStub("LibRevision"):Set("$URL: Stubby/Stubby.lua $","$Rev: 6920 $","5.1.DEV.", 'auctioneer', 'libs')
...
function getRevision()
	return tonumber(("$Rev: 6920 $"):match("(%d+)"))
end
